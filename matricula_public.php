<?php
// Se han eliminado las líneas de verificación de sesión y rol
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body style="background-color: #E7F9FD; font-family: 'Segoe UI', sans-serif;">
  <div class="container py-5 d-flex justify-content-center">
    <div class="w-100" style="max-width: 900px; background-color: #ffffff; padding: 40px; border-radius: 32px; box-shadow: 0 10px 30px rgba(0,0,0,0.08);">
      ...
      <?php
         // Verificar si viene de nueva inscripción
       $esNuevo = isset($_GET['nuevo']) && $_GET['nuevo'] == '1';
       $documentoPreLlenado = $_GET['doc'] ?? '';
       ?>
      <!-- Mostrar badge si es nueva inscripción -->
      <?php if ($esNuevo): ?>
      <div class="text-center mb-3">
      <span class="badge bg-success">
      <i class="bi bi-person-plus me-2"></i>NUEVA INSCRIPCIÓN 2026
      </span>
      </div>
      <?php endif; ?>
      ...
      <ul>
        ...
        <li>Una vez diligenciado el presente formulario, debe realizar la consignación correspondiente en la cuenta del Club Deportivo SIAO por concepto de matricula anual.</li>
      ...
      <form action="/APP/controllers/guardar_inscripcion.php" method="POST" enctype="multipart/form-data" onsubmit="validarFormulario(event)">
        <div class="row g-3">
          <!-- Nombre completo -->
          <div class="col-md-6">
